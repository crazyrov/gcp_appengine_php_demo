...
<body style="background: rgba(88, 164, 172, 100);">
    ...
    <div class="row justify-content-center align-items-center">
        <p style="color:rgba(216, 219, 226, 100);font-size:5rem;font-family: Dosis;">The requested page is not found.</p>
    </div>

    <div class="row justify-content-center align-items-center">
        <p style="color:red;font-size:25rem;font-family: Dosis;">404</p>
    </div>
